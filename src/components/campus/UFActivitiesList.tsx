        ...
        <div className="space-y-1.5">
          {acts.map((a, i) => (
            <button
              ...
              className="w-full text-left flex items-center gap-3 p-2.5 rounded-lg border border-border/60 bg-card hover:border-green-400/60 hover:bg-green-50/40 dark:hover:bg-green-950/20 transition"
            >
